...
const file_payment_payment_api_proto_rawDesc = "" +
	...
	"\x10CARD_TYPE_REWARD\x10\x042\xbf\x02\n" +
...
var file_payment_payment_api_proto_depIdxs = []int32{
	...
	3, // 4: rpc.payment.v1.PaymentService.MakePayment:input_type -> rpc.payment.v1.PaymentRequest
	2, // 5: rpc.payment.v1.PaymentService.MarkInvoicePaid:input_type -> rpc.payment.v1.Invoice
	2, // 6: rpc.payment.v1.PaymentService.PayInvoice:input_type -> rpc.payment.v1.Invoice
	4, // 7: rpc.payment.v1.PaymentService.MakePayment:output_type -> rpc.payment.v1.PaymentResponse
	2, // 8: rpc.payment.v1.PaymentService.MarkInvoicePaid:output_type -> rpc.payment.v1.Invoice
	2, // 9: rpc.payment.v1.PaymentService.PayInvoice:output_type -> rpc.payment.v1.Invoice
