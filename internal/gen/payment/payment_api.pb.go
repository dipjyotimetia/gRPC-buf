...
type Invoice struct {
	...
	Name   string       `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`     // Invoice name
...
type PaymentRequest struct {
	...
	CardNo         int64                  `protobuf:"varint,1,opt,name=CardNo,proto3" json:"CardNo,omitempty"`                                      // Card number
	...
	Address        []string               `protobuf:"bytes,4,rep,name=address,proto3" json:"address,omitempty"`                                     // Card holder's address
...
type PaymentResponse_Paid struct {
	Paid bool `protobuf:"varint,1,opt,name=paid,proto3,oneof"` // Indicates if the payment was successful
}

type PaymentResponse_Error struct {
	Error string `protobuf:"bytes,2,opt,name=error,proto3,oneof"` // Payment error message (if any)
}
